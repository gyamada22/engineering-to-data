...
### **Módulo 5: Ordenando e Filtrando** ✅
🔹 10 exercícios | Tópicos: ORDER BY, DISTINCT, WHERE, BETWEEN, IN, LIKE, TOP
...
🔹 5 exercícios | Tópicos: COUNT, SUM, AVG, MIN, MAX, agregação básica
...
### **Módulo 7: Agrupamentos** ✅
🔹 10 exercícios | Tópicos: GROUP BY, HAVING, agrupamento com filtros
...
### **Módulo 8: JOINs** ✅
🔹 10 exercícios | Tópicos: INNER JOIN, LEFT JOIN, RIGHT JOIN, múltiplos JOINs
...
### **Módulo 9: Group By + Joins**  ✅
🔹 10 exercícios | Tópicos: Combinação GROUP BY com JOINs, agregação em múltiplas tabelas
...
### **Módulo 10: Variáveis** ✅
🔹 5 exercícios | Tópicos: DECLARE, SET, variáveis locais, uso em queries
...
### **Módulo 11: Manipulando Strings e Datas** ✅
🔹 6 exercícios | Tópicos: CONCAT, SUBSTRING, LEN, GETDATE, DATEADD, DATEDIFF, formatação
...
🔹 6 exercícios | Tópicos: CASE WHEN, IIF, COALESCE, ISNULL, lógica condicional
...
### **Módulo 13: SQL Views** ✅
🔹 6 exercícios | Tópicos: CREATE VIEW, ALTER VIEW, DROP VIEW, views com JOINs
...
### **Módulo 14: CRUD** ✅
🔹 6 exercícios | Tópicos: INSERT, UPDATE, DELETE, MERGE, operações DML
...
### **Módulo 15: Subqueries e CTE's** ✅ 
🔹 10 exercícios | Tópicos: CTE (WITH), Subqueries correlacionadas, EXISTS, NOT EXISTS, UNION
...
🔹 3 exercícios | Tópicos: WHILE, BREAK, CONTINUE, variáveis de controle, loops com condições
- 📄 [Lista de Exercícios](https://github.com/gyamada22/portfolio-sql-jornada-/blob/main/exercicios-pdf/Lista%20de%20Exerc%C3%ADcios%2016%20-%20Loops%20.pdf)
- 💻 [Minha Resolução](https://github.com/gyamada22/portfolio-sql-jornada-/blob/main/exercicios-pdf/Resolu%C3%A7ao%20Exercicios%2016)

### **Módulo 17: Window Functions** ✅ 
🔹 8 exercícios | Tópicos: ROW_NUMBER, RANK, DENSE_RANK, NTILE, LAG, LEAD, PARTITION BY, OVER()
